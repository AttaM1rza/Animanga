...
from userInterface import add_newAnime, show_allAnimes, watchMODE, display_disclaimer, get_userInp_addAnime
...
dataHandler = DataHandler(data_path) #TODO: implement as singelton !
def main():
    ...
    while(keepMenu):
        ...
        show_allAnimes(dataHandler.get_data())
        print("")
        ...
        if user_choice == -1: break
            ...
            #add new Entry
            anime = get_userInp_addAnime()
            dataHandler.add_anime(anime)
